                ...
                control: {
                    selectors: {
                        '&[data-orientation="vertical"]': {
                            width: 'calc(var(--slider-thumb-size) + var(--size-selector) * 2)',
                            height: 'var(--slider-length)',
                            '--slider-track': 'linear-gradient(to top, var(--slider-accent) var(--slider-percent, 50%), var(--color-base-300) 0)',
                        },
                ...
                track: {
                    selectors: {
                        '&[data-orientation="vertical"]': {
                            ...
                            height: 'var(--slider-length)',
                            marginBlock: '0',
                            marginInline: 'calc((var(--slider-thumb-size) - var(--slider-track-size)) / 2 + var(--size-selector))',
                        },
                    },
                },
                range: {
...
export const accordion: RecipeInput = {
    ...
    parts: {
        root: {
            ...
            // the dividing hairline turns with them.
        ...
        item: withPresence(disclosurePresence, {
            ...
            selectors: {
                ...
                '[data-scope="accordion"][data-part="root"][data-orientation="horizontal"] > &': {
                    ...
                    minInlineSize: '0',
                    borderBlockEnd: 'none',
                    borderInlineEnd: 'var(--border) solid var(--hero-line)',
                },
...
export const table: RecipeInput = {
    ...
    parts: {
        ...
        // Sorting (#286): HeroUI's sortable column — the muted label goes to
        // foreground when sorted, and the chevron beside it turns.
        'sort-trigger': {
            base: {
                appearance: 'none',
                display: 'inline-flex',
        ...
        // zero's ▲, turned for descending; unsorted, it appears only under a
        // hovered or keyboard-focused trigger.
        'sort-indicator': {
            base: {
                display: 'inline-block',
                fontSize: '0.7em',
