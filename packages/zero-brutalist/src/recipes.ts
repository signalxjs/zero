...
export const button: RecipeInput = {
    ...
    parts: {
        ...
        spinner: {
            base: {
                ...
                animation: 'zero-brutalist-btn-spin 0.9s linear infinite',
            },
    ...
    keyframes: { 'zero-brutalist-btn-spin': 'to { transform: rotate(360deg) }' },
};
        ...
        thumb: {
            ...
            at: {
                ...
                'forced-colors': {
                    ...
                    selectors: { '[data-scope="switch"][data-part="control"][data-disabled] &': { background: 'GrayText' } },
                },
            },
        },
...
export const combobox: RecipeInput = {
    ...
    parts: {
        ...
        // Clears the value and the text (#280): the arrow's bare glyph, one
        // step before it — a base-200 block on hover.
        'clear-trigger': {
            base: {
                appearance: 'none',
                border: 'none',
        ...
        // The list still arriving (#280): the empty row's stencil.
        loading: {
            base: {
                padding: 'var(--space-md)',
                ...label,
...
export const badge: RecipeInput = {
        ...
        dot: {
            ...
            states: {
                running: {
                    ...
                    animation: 'zero-brutalist-badge-pulse 1.6s ease-out infinite',
                },
            },
            at: {
    ...
    variants: {
        ...
        'zero-brutalist-badge-pulse': 'from { box-shadow: 0 0 0 0 color-mix(in oklch, var(--badge-dot) 45%, transparent); } to { box-shadow: 0 0 0 0.5em transparent; }',
    },
};
...
export const pagination: RecipeInput = {
    ...
    tokens: {
        ...
        '--pg-ring-room': 'calc(var(--border) + 3px)',
    },
    parts: {
        root: {
            ...
            // border-weight outline + 3px offset (which also covers the 3px
            // hard shadow and the pressed sink), which the scroll box would
            // otherwise clip at the row's edges; the matching scroll padding
            // keeps it clear when focus scrolls a page into view.
            base: {
                display: 'flex',
                alignItems: 'center',
                gap: 'var(--space-xs)',
...
export const table: RecipeInput = {
    ...
    parts: {
        ...
        // below the table's breakpoint; the card it becomes is drawn here.
            ...
            at: tableStackAt(tokens, 'root', { border: '0', background: 'transparent', boxShadow: 'none' }),
        },
        table: {
            base: {
        ...
        body: { at: tableStackAt(tokens, 'body', { rowGap: 'var(--space-lg)' }) },
        foot: {
            base: {
                borderBlockStart: 'calc(var(--border) * 2) solid var(--color-base-content)',
                fontSize: 'var(--text-xs)',
            },
            at: tableStackAt(tokens, 'foot', { rowGap: 'var(--space-lg)', marginBlockStart: 'var(--space-lg)', borderBlockStart: '0' }),
        },
        row: {
        ...
        // Sorting (#286): the mono label made a button. Sorting inverts it —
        // the sorted column's label is a slab of accent with its ink — and the
        // mark flips with no easing, the way everything here moves.
        'sort-trigger': {
            base: {
                appearance: 'none',
                display: 'inline-flex',
            ...
            states: {
                ascending: { background: 'var(--table-accent)', color: 'var(--table-accent-ink)' },
                descending: { background: 'var(--table-accent)', color: 'var(--table-accent-ink)' },
                none: {},
                hover: { textDecorationLine: 'underline', textDecorationThickness: 'var(--border)' },
                disabled: { cursor: 'not-allowed', opacity: 'var(--disabled-opacity)' },
                ...focusRing,
            },
        },
        // zero's ▲, flipped for descending; an unsorted column's is gone until
        // the trigger is hovered or keyboard-focused.
        'sort-indicator': {
            base: { display: 'inline-block', lineHeight: '1' },
            states: {
                ascending: {},
                descending: { transform: 'scaleY(-1)' },
                none: { opacity: '0' },
            },
        ...
        // A stacked cell's column label: the header's mono uppercase label.
        'cell-label': {
            base: {
                ...label,
                fontSize: 'var(--text-xs)',
