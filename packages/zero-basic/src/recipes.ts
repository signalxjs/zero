    ...
    targets: {
        web: {
            parts: {
                control: {
                    ...
                    selectors: {
                        ...
                        '&[data-orientation="vertical"]': {
                            ...
                            '--slider-track':
                                'linear-gradient(to top, var(--slider-accent) var(--slider-percent, 50%), var(--color-base-200) 0)',
                        },
                ...
                // physical `bottom` percents; this turns the channel upright
                // and re-centres the disc on the other axis. Web-only: the
                // lynx runtime ships no vertical slider.
                root: {
                    selectors: {
                        '&[data-orientation="vertical"]': {
                            width: 'auto',
...
export const treeView: RecipeInput = {
    ...
    parts: {
        ...
        'branch-indicator': {
            ...
            // Loading: the chevron is caught mid-turn — an engineered,
            // static tell (no loop to stop under reduced motion), and it
            // leaves the glyph's ink, so its contrast is the closed one's.
...
export const table: RecipeInput = {
    ...
    parts: {
        root: {
            ...
            // The scroll box is a keyboard stop (#270): the skin's ring,
        ...
        // The column label a stacked cell opens with — the header cell's mono
        // meta voice, so a card reads like the table it came from.
        'cell-label': {
            base: {
                fontFamily: 'var(--font-mono)',
                fontWeight: 'var(--weight-medium)',
