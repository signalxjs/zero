                ...
                control: {
                    selectors: {
                        '&[data-orientation="vertical"]': {
                            ...
                            '--slider-track': 'linear-gradient(to top, var(--carbon-interactive) var(--slider-percent, 50%), var(--carbon-line) 0)',
                        },
                        // `invalid` restates the track wholesale (above), so its
                        // vertical spelling has to as well.
                        '&[data-orientation="vertical"][data-invalid]': {
                            '--slider-track': 'linear-gradient(to top, var(--carbon-danger) var(--slider-percent, 50%), var(--carbon-line) 0)',
                        },
                ...
                track: {
                    selectors: {
                        '&[data-orientation="vertical"]': {
                            ...
                            height: 'var(--slider-length)',
                            marginBlock: '0',
                            marginInline: 'calc((var(--slider-control-size) - var(--slider-track-size)) / 2)',
                        },
                    },
                },
                range: {
...
export const accordion: RecipeInput = {
    ...
    parts: {
        root: {
            ...
            // `orientation="horizontal"` (#276): the rows sit side by side,
            // the block-start hairlines joining into one rule above them.
...
export const treeView: RecipeInput = {
    ...
    parts: {
        ...
        'branch-indicator': {
            ...
            // Loading: the chevron sits half-turned — static (no loop), same
            // ink, so contrast is untouched.
