...
type TimelineMarkerAdapted = Adapted<typeof ZTimeline.Marker, 'color', Record<never, never>>;
...
type StepsItemAdapted = Adapted<typeof ZSteps.Item, 'color', Record<never, never>>;
