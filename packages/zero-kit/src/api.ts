...
export const RESERVED_PROPS_BY_SCOPE: Readonly<Record<string, readonly string[]>> = {
    ...
    combobox: ['allowCustom', 'anchor', 'clearable', 'defaultInputValue', 'defaultOpen', 'defaultValue', 'emptyText', 'estimateItemSize', 'filter', 'form', 'id', 'invalid', 'itemDisabled', 'itemGroup', 'itemInsert', 'itemKey', 'itemLabel', 'itemValue', 'items', 'loading', 'loadingText', 'multiple', 'name', 'openOnClick', 'placeholder', 'placement', 'positionStrategy', 'readonly', 'required', 'role', 'title', 'trigger', 'value', 'virtual'],
    ...
    select: ['clearable', 'defaultOpen', 'defaultValue', 'estimateItemSize', 'form', 'id', 'invalid', 'itemDisabled', 'itemGroup', 'itemKey', 'itemLabel', 'itemValue', 'items', 'multiple', 'name', 'placeholder', 'placement', 'positionStrategy', 'readonly', 'required', 'role', 'title', 'value', 'virtual'],
