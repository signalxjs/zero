...
export const RESERVED_PROPS_BY_SCOPE: Readonly<Record<string, readonly string[]>> = {
    ...
    checkbox: ['defaultChecked', 'form', 'hideLabel', 'id', 'indeterminate', 'invalid', 'name', 'readonly', 'required', 'title', 'value'],
    collapsible: ['defaultOpen', 'id', 'role', 'title', 'value'],
    container: ['id', 'measure', 'pad', 'padX', 'padY', 'role', 'title'],
    combobox: ['allowCustom', 'anchor', 'defaultInputValue', 'defaultOpen', 'defaultValue', 'emptyText', 'estimateItemSize', 'filter', 'form', 'id', 'invalid', 'itemDisabled', 'itemGroup', 'itemInsert', 'itemKey', 'itemLabel', 'itemValue', 'items', 'multiple', 'name', 'openOnClick', 'placeholder', 'placement', 'positionStrategy', 'readonly', 'required', 'role', 'title', 'trigger', 'value', 'virtual'],
    ...
    select: ['defaultOpen', 'defaultValue', 'estimateItemSize', 'form', 'id', 'invalid', 'itemDisabled', 'itemGroup', 'itemKey', 'itemLabel', 'itemValue', 'items', 'multiple', 'name', 'placeholder', 'placement', 'positionStrategy', 'readonly', 'required', 'role', 'title', 'value', 'virtual'],
    skeleton: ['defaultLoading', 'id', 'role', 'title', 'value'],
    spacer: ['id', 'role', 'space', 'title'],
    slider: ['defaultValue', 'form', 'getValueText', 'id', 'invalid', 'marks', 'max', 'min', 'name', 'readonly', 'role', 'step', 'title', 'value'],
    ...
    'tree-view': ['defaultExpandedValues', 'defaultValue', 'expandOnClick', 'id', 'role', 'title', 'value'],
};
