...
export const RESERVED_PROPS_BY_SCOPE: Readonly<Record<string, readonly string[]>> = {
    ...
    alert: ['defaultOpen', 'id', 'title', 'value'],
    ...
    combobox: ['allowCustom', 'defaultInputValue', 'defaultOpen', 'defaultValue', 'emptyText', 'estimateItemSize', 'filter', 'form', 'id', 'invalid', 'itemDisabled', 'itemGroup', 'itemKey', 'itemLabel', 'itemValue', 'items', 'multiple', 'name', 'placeholder', 'placement', 'positionStrategy', 'readonly', 'required', 'role', 'title', 'trigger', 'value', 'virtual'],
    ...
    input: ['autocomplete', 'defaultValue', 'form', 'id', 'invalid', 'maxlength', 'name', 'readonly', 'required', 'role', 'title', 'type', 'value'],
    join: ['id', 'role', 'title'],
    kbd: ['id', 'role', 'title'],
    ...
    'radio-group': ['defaultValue', 'form', 'id', 'invalid', 'itemDisabled', 'itemKey', 'itemLabel', 'items', 'name', 'required', 'title', 'value'],
    'rating-group': ['allowHalf', 'count', 'defaultValue', 'deselectable', 'form', 'id', 'invalid', 'itemLabel', 'name', 'readonly', 'required', 'role', 'title', 'value'],
    select: ['defaultOpen', 'defaultValue', 'estimateItemSize', 'form', 'id', 'invalid', 'itemDisabled', 'itemGroup', 'itemKey', 'itemLabel', 'itemValue', 'items', 'multiple', 'name', 'placeholder', 'placement', 'positionStrategy', 'required', 'role', 'title', 'value', 'virtual'],
    skeleton: ['defaultLoading', 'id', 'role', 'title', 'value'],
    spacer: ['id', 'role', 'space', 'title'],
    slider: ['defaultValue', 'form', 'getValueText', 'id', 'invalid', 'marks', 'max', 'min', 'name', 'role', 'step', 'title', 'value'],
    spinner: ['id', 'label', 'title'],
    ...
    'tree-view': ['defaultExpandedValues', 'defaultValue', 'id', 'role', 'title', 'value'],
};
