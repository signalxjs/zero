...
declare module '@sigx/zero' {
    interface ZeroVocabulary {
        ...
        components: {
            ...
            /** container — no axis wired by heroui; every axis errors under this register module. */
            'container': {
                /** Accepts `color` at runtime, but heroui declares no color axis for container — the attribute would match nothing. */
                color: never;
                /** Accepts `size` at runtime, but heroui declares no size axis for container — the attribute would match nothing. */
                size: never;
                /** Accepts `variant` at runtime, but heroui declares no variant axis for container — the attribute would match nothing. */
                variant: never;
                axes: Record<string, never>;
                mods: Record<string, never>;
            };
